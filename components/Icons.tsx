...
// Generic icon for an image placeholder.
...
// Search icon, used for finding artwork.
...
// Refresh icon for changing artwork.
export const RefreshIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h5M20 20v-5h-5M4 4l1.5 1.5A9 9 0 0120 10.5M20 20l-1.5-1.5A9 9 0 004 13.5" />
    </svg>
);

// Sparkles icon, used as a placeholder in the poem area.
...
// Pencil icon for the generate button.
...
// Document icon for the log download button.
...
// Info icon for the artwork details button.
...
// Menu icon for opening the bookmarks panel.
...
// Ban icon for disabled features.
export const BanIcon: React.FC<{ className?: string }> = ({ className = "h-10 w-10" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" />
    </svg>
);

// Coffee icon for the "buy me a coffee" link.
export const CoffeeIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-stone-700" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11 5h2.286a2 2 0 011.838 2.802l-.657 2.626A2 2 0 0016.29 13H17a2 2 0 012 2v1a2 2 0 01-2 2h-1m-5 0v2m0-2H7a2 2 0 01-2-2v-1a2 2 0 012-2h1.71a2 2 0 001.823-2.802l-.657-2.626A2 2 0 018.04 5H6V4h5v1z" />
    </svg>
);

// Envelope Icon for feedback
export const EnvelopeIcon: React.FC<{ className?: string }> = ({ className = "h-6 w-6 text-stone-500" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
    </svg>
);

// Share icon for the Web Share API.
