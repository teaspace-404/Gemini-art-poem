...
const App: React.FC = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col">
            <header className="sticky top-0 z-40 w-full bg-stone-100/80 backdrop-blur-sm border-b border-stone-200">
                <div className="max-w-5xl mx-auto flex justify-between items-center p-2 sm:px-4">
